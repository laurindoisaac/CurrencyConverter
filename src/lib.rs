// src/lib.rs
/*
 * Core library for CurrencyConverter
 */
...
#[derive(Debug)]
pub struct CurrencyConverterProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CurrencyConverterProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CurrencyConverter processing");
    
    let mut processor = CurrencyConverterProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CurrencyConverterProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CurrencyConverterProcessor::new(false);
